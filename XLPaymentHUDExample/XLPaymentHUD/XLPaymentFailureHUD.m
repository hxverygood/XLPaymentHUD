...
- (void)checkAnimation {
    ...
    [path moveToPoint:CGPointMake(a*7.0/10,a*3.0/10)];
    [path addLineToPoint:CGPointMake(a*3.0/10,a*7.0/10)];
    
    [path moveToPoint:CGPointMake(a*3.0/10,a*3.0/10)];
    [path addLineToPoint:CGPointMake(a*7.0/10,a*7.0/10)];
